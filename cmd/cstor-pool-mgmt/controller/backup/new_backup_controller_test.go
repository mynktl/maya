...
import (
	...
	openebsFakeClientset "github.com/openebs/maya/pkg/client/generated/openebs.io/backup/v1alpha1/clientset/internalclientset/fake"
...
func TestNewCStorBackupController(t *testing.T) {
	...
	backupController := NewController(fakeKubeClient, fakeOpenebsClient, kubeInformerFactory,
