...
import (
	...
	restorev1alpha1 "github.com/openebs/maya/pkg/apis/openebs.io/restore/v1alpha1"
	internalclientset "github.com/openebs/maya/pkg/client/generated/openebs.io/restore/v1alpha1/clientset/internalclientset"
	internalinterfaces "github.com/openebs/maya/pkg/client/generated/openebs.io/restore/v1alpha1/informer/externalversions/internalinterfaces"
	v1alpha1 "github.com/openebs/maya/pkg/client/generated/openebs.io/restore/v1alpha1/lister/restore/v1alpha1"
...
func (f *cStorRestoreInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&restorev1alpha1.CStorRestore{}, f.defaultInformer)
}
