...
import (
	v1alpha1 "github.com/openebs/maya/pkg/apis/openebs.io/backup/v1alpha1"
...
func (c *FakeCStorBackups) UpdateStatus(cStorBackup *v1alpha1.CStorBackup) (*v1alpha1.CStorBackup, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(cstorbackupsResource, "status", c.ns, cStorBackup), &v1alpha1.CStorBackup{})
...
func (c *FakeCStorBackups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.CStorBackup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(cstorbackupsResource, c.ns, name, data, subresources...), &v1alpha1.CStorBackup{})
